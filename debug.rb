# the class name was not capitalized
class Ferret
...
# inconsistency in spelling chinchilla
class Chinchilla
...
class Parrot
    ...
    # name should have been parrot_name
		@name = parrot_name
	end
...
# some of the code was repetetive too
